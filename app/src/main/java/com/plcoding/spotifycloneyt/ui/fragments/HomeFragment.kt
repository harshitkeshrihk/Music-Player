            ...
            when(result.status){
                Status.SUCCESS -> {
                    ...
                    result.data?.let{  songs->
                        songAdapter.songs = songs  // this will trigger setter of songs list in adapter and it will submit new list to list differ
                    }
                }
                Status.ERROR -> Unit
                Status.LOADING -> allSongsProgressBar.isInvisible = true
            }
