...
class SongFragment: Fragment(R.layout.fragment_song) {
    ...
    private lateinit var mainViewModel: MainViewModel         //to bind its lifecycle with this main activity only
    private val songViewModel: SongViewModel by viewModels()  //to bind its lifecycle with this song fragment only
    ...
    private fun subscribeToObservers(){
        ...
        mainViewModel.playbackState.observe(viewLifecycleOwner){
         playbackState = it
            ...
            seekBar.progress = it?.position?.toInt() ?: 0 //for change in seekbar progress
        }
